  ...
  return (
    <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-3xl p-6 shadow-xl">
      ...
      <div className="space-y-4">
        {userType === 'residente' && (
          <>
            <Link href="/crear-incidencia" className="block w-full bg-yellow-600 hover:bg-yellow-700 text-white text-center py-3 rounded-lg font-medium transition duration-300">
